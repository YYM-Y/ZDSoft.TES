...
namespace ZDSoft.TES.Web.Apps
{
    public class AppHelper
    {
      ...
      //  public static IList<SystemFunction> privileges;
        ...
        //                if (role != null)
        //                {
        //                    foreach (SystemFunction function in role.SystemFunctionList)//获取当前用户可以操作的功能
        //                    {
        ...
        //                        else
        //                        {
        //                            if (function.ParentSysMenu!=null)
        //                            {
        //                                if (privilegeList.Where(o => o.ID == function.ParentSysMenu.ID).Count() < 1)
        //                                {
        //                                    privilegeList.Add(function.ParentSysMenu);
        //                                }
        //                            }
